...
CREATE INDEX IF NOT EXISTS idx_task_user_deleted_created
    ON task(user_id, is_deleted, created_at DESC);

CREATE INDEX IF NOT EXISTS idx_task_user_deleted_completed
...
CREATE INDEX IF NOT EXISTS idx_attachment_user_id
